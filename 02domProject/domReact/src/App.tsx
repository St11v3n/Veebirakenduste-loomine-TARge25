...
function App() {
  ...
  // kuvad need hierarhiliselt, näidates iga elemendi lapsi ja vanemaid.
  // See on kasulik, kui soovite näha, kuidas elemendid on omavahel seotud
  // ja kuidas nad on paigutatud lehel. See võtab teil mõista,
  // kuidas leht on üles ehitatud ja kuidas erinevad elemendid omavel seotud on.
  //console.dir(document);

  // Nüüd proovie muuta documendi title-i, mis on DOM-i element.
  // See on nagu veebilehe pealkiri, mis kuvatakse brauseri vahekaardil.
  // document.title = "DOM-i pealkiri on muudetud"
  //document.title = "DOM-i pealkiri on muudetud"

  // nüüd proovime muuta documendi body taustavärvi, mison DOM--i element.
  ...
  // See on nagu veebilee kasutajanimi, mis võib olla tühi või sisaldada
  ...
  return (
    ...
    <>
        ...
        <p>
          ...
          on võimalik teha staatiline left dünaamiliseks. JS/TS on
