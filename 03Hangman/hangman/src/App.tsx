...
import './App.css'
//see fuktsioon tagastab suvalise sõna wordList.json failist
function getWord() {
...
//Stringi kasutan kuna viitan, et on tegemist ainult stringiga
  ...
  //kui oled pakkunud valesi tähti kuus korrda, siis kaotad
  ...
  const addGuessedLetter = useCallback
    ((letter: string) => {
      //isLoser ja isWinner javastavalt sellele annab tulemuse
      if (guessedLetters.includes(letter) || isLoser || isWinner)
        return
      //funktsioon on edasi aantud setter,võta praegune olek ja returni uus versioon või situatsioon
